        ...
        <div class="row">
          <div class="col-6 col-md-2 mb-3">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Hospital Selection / Bookings</a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Visa Solutions</a></li>
              <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Emergency Medical Travel</a></li>
            </ul>
          </div>
          ...
          <div class="col-6 col-md-3 mb-3" align="center">
            <img src="./image/igs medical tourism LOGO.png" class="img-fluid" style="width: 200px; align-content: center;">
            <h5 class="h2" style="color: red; font-size: 28px; text-align: center; letter-spacing: 1.6px;">IGS MEDICAL</h5>
            <h5 class="h5" style="letter-spacing: 13px; text-align: center; font-size: 21px;">  TOURISM</h5>
